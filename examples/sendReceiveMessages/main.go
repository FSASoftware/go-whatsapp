...
func sendMessage(jid string, messageText string, wac *whatsapp.Conn) error {
...
func main() {
	...
	//Add handler
	wac.AddHandler(&waHandler{wac, outChan})
	...
	for {
		fmt.Println("Insert jid and message:")
		select {
		case rcvMessage := <-outChan:
			fmt.Println()
